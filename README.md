...
| 프로젝트                                                                                             | 설명                    | 기술 스택                             | 비고                    |
| ------------------------------------------------------------------------------------------------ | --------------------- | --------------------------------- | --------------------- |
| **[WISH](https://github.com/Seorins/WISH)** | 소아암 환아를 위한 행동 기반 감정 회복 마을 플랫폼 | Spring Boot, React, Phaser | SSAFY 자율 프로젝트 |
...
| **Interactive Color Psychology<br>Contents using Augmented Reality** | 증강현실 기반 인터랙티브 색채 심리 콘텐츠 | Spark AR, Hand Tracking, 3D Modeling | 한국정보기술학회 대학생 논문경진대회 은상 |
---
